...
### 01:10 KST — moat-quality-v2-rev3-research-contract
...
- CI에서 새 moat regression은 PIT cache-dependent legacy test보다 먼저 실행.
...
**Validation**: common revised offline suite 20/20 PASS; exact-head GitHub CI/review required before merge.

**Separate blocker**: existing Phase C1 GitHub PIT-universe test depends on historical cache that is absent on clean runner. Fix in a separate H1 PR; do not mask with continue-on-error.
